...
A: Yes, use the desktop launcher, beta CLI launcher, or manual installation [directions here](https://wiki.d2r-reimagined.com/en/Installs).
...
A: No. The skill is very hard-coded.
...
A: No, this is an account bound feature and can no longer be modded.

**Q: Can you make auras useable on left-click?**
A: No, they will not activate, this is an engine limitation.
